...
PPPwn is a kernel remote code execution exploit for PlayStation 4 up to FW 11.50. This is a proof-of-concept exploit (https://hackerone.com/reports/*******). 
...
```sh
git clone --recursive https://github.com/UnknwnStatz1/PPPwn-4.0/tree/main/PPPwn%204.0
```
...
```sh
make -C stage1 FW=1150 clean && make -C stage1 FW=1150
make -C stage2 FW=1150 clean && make -C stage2 FW=1150
```
...
```sh
sudo python3 pppwn.py --interface=enp0s3 --fw=1150
```
...
[+] args: interface=enp0s3 fw=1150 stage1=stage1/stage1.bin stage2=stage2/stage2.bin
